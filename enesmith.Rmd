...
p1 <- plot_ly(
  ...
  type = "bar") %>% 
  layout(title = "Citizen-Reported Sewer and Water Damage by Neighborhood")
...
p2 <- plot_ly(
  ...
  type = "bar") %>% 
  layout(title = "Citizen-Reported Power Damage by Neighborhood")
...
p3 <- plot_ly(
  ...
  type = "bar") %>% 
  layout(title = "Citizen-Reported Roads and Bridges Damage by Neighborhood")
```
...
p4 <- plot_ly(
  ...
  type = "bar") %>% 
  layout(title = "Citizen-Reported Medical Damage by Neighborhood")
```
...
p5 <- plot_ly(
  ...
  type = "bar") %>% 
  layout(title = "Citizen-Reported Building Damage by Neighborhood")
```
...
p6 <- plot_ly(
  ...
  type = "bar") %>% 
  layout(title = "Citizen-Reported Shake Intensity by Neighborhood")
```
